...
venv = util.make_vec_env("MiniGrid-LavaCrossingS9N1-v0", n_envs=1, post_wrappers= [wrappers.FlatObsWrapper],  post_wrappers_kwargs=[{}],)
...
trained_policy = PPO.load("gail_gen_2")
