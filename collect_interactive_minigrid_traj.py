...
venv = env_utils.minigrid_get_env("MiniGrid-Empty-Random-6x6-v0", flat = False, n_envs=1, partial=False, encoder=encoder_model)
...
with open('traj_datasets/empty6x6_encoded_100.pkl', 'wb') as handle:
    pickle.dump(traj_dataset, handle, protocol=pickle.HIGHEST_PROTOCOL)
    print("wrote to pkl")