...
from utils.env_utils import minigrid_render, minigrid_get_env, seed_everything
import os, time
import numpy as np
...
from imitation.algorithms import bc
import msvcrt
from BaC.bac_triplet_svdd_rnn import BaC_RNN_Triplet_SVDD
...
bac_trainer = BaC_RNN_Triplet_SVDD(
    train_env,
