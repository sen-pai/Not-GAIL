...
class SomethingTrainer:
    ...
    def __init__(
        ...
        anything_trainers, #instances of anything trainers from anything_module
        discrim: discrim_nets.DiscrimNet,
        expert_data: Union[Iterable[Mapping], types.Transitions],
        expert_batch_size: int,
        n_disc_updates_per_round: int = 2,
        anything_steps: int = int(1e3), 
        *,
        log_dir: str = "output/",
        ...
        self.anything_trainers = anything_trainers #A list of anything trainers
        self.anything_steps = anything_steps
        ...
        if debug_use_ground_truth:
            ...
            #use something wrapper instead
            all_reward_fns = [self.discrim.predict_reward_train]
            for anything in self.anything_trainers:
                all_reward_fns.append(anything.discrim.neg_predict_reward_train)

            self.venv_wrapped = reward_wrapper.SomethingRewardVecEnvWrapper(
                self.venv_norm_obs, all_reward_fns
            )
    ...
    def train_disc(
        ...
        *,
        ...
        """
        with logger.accumulate_means("something disc"):
    ...
    def train_gen(
        ...
        with logger.accumulate_means("something gen"):
            self.gen_algo.learn(
...
class SomethingGAIL(SomethingTrainer):
    def __init__(
        self,
        venv: vec_env.VecEnv,
        expert_data: Union[Iterable[Mapping], types.Transitions],
        ...
        **kwargs,
        ...
        super().__init__(
            venv, gen_algo, anything_trainers, discrim, expert_data, expert_batch_size, **kwargs
        )
