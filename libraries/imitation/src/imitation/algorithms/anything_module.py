...
from imitation.rewards import neg_discrim_nets, reward_nets
...
class AdversarialTrainer:
    ...
    def __init__(
        ...
        discrim: neg_discrim_nets.DiscrimNet,
        ...
        *,
        ...
        # dummpy_rewardfn: bool = True, #ADDED
    ):
        ...
        if debug_use_ground_truth:
            ...
            self.gen_callback = self.venv_train.make_log_callback()
            ...
            self.neg_gen_callback = self.venv_neg_train.make_log_callback()
    ...
    def train_neg_gen(
        ...
        with logger.accumulate_means("neg_gen"):
            self.neg_gen_algo.learn(
                total_timesteps=total_timesteps,
                reset_num_timesteps=False,
                callback=self.neg_gen_callback,
                **learn_kwargs,
            )
            self._global_step += 1
...
class AnythingGAIL(AdversarialTrainer):
    def __init__(
        self,
        venv: vec_env.VecEnv,
        expert_data: Union[Iterable[Mapping], types.Transitions],
        ...
        **kwargs,
        ...
        discrim = neg_discrim_nets.DiscrimNetGAIL(
            venv.observation_space, venv.action_space, **discrim_kwargs
        )
        super().__init__(
            venv, gen_algo, neg_gen_algo, discrim, expert_data, expert_batch_size, **kwargs
        )
