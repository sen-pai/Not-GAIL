...
from bac_utils.env_utils import minigrid_get_env_rew_times, minigrid_render
...
train_env = minigrid_get_env_rew_times(args.env, args.nenvs, args.flat)
eval_env = minigrid_get_env_rew_times(args.env, 1, args.flat)

if args.show and not args.flat:
    minigrid_render(train_env.reset())

save_path = "./logs/" + args.env + "/ppo_rew/" + args.run
